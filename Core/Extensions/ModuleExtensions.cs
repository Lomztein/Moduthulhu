...
namespace Lomztein.Moduthulhu.Core.Extensions
{
    ...
    {
        public static string CompactizeName (this IPlugin plugin) => (plugin.Author + "_" + plugin.Name);
        ...
        public static string[] GetDependencyNames(this IPlugin module) => module.GetType ().GetCustomAttributes (typeof (DependencyAttribute), false).Cast<DependencyAttribute> ().Select (x => x.DependencyName).ToArray ();
